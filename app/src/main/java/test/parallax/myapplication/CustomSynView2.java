...
public class CustomSynView2 extends View {
    ...
    public CustomSynView2(Context context) {
        super(context);
        init();
    }

    public CustomSynView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomSynView2(Context context, AttributeSet attrs, int defStyleAttr) {
